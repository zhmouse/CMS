...
<div id="dcWrap"> <div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.html"><img src="statics/images/dclogo.gif" alt="logo"></a></div>
  <div class="nav">
   <ul>
   ...
   <ul class="navRight">
    <li class="M noLeft"><a href="JavaScript:void(0);">您好，<?= $_SESSION['userinfo']['uname']?></a>
...
<!-- </ul>-->
 ...
 <div id="dcMain"> <!-- 当前位置 -->
<div id="urHere">网站内容管理中心</div>  <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;height:550px;min-height:550px;">
